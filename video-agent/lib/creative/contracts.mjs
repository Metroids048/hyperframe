...
export function normalizeCommerceRequest(input = {}) {
  ...
  return {
    ...
    businessGoal: [...new Set((Array.isArray(input.businessGoal)?input.businessGoal:[]).filter(g=>['product_launch','product_howto','launch','detail','demo','style','promotion','faq','recut','versions'].includes(g)))],
