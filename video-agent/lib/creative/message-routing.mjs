...
async function legacyRoute(project,message,{provider,signal,document=null,taskMode,taskModeExplicit=false,scenarioId=null,onInvocation,cacheRoot}={}) {
  ...
  const own=!provider;provider??=new CodexProvider({onInvocation,cacheRoot});
  try {
