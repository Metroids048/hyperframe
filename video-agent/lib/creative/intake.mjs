...
export function commerceIntake(input={}){
 ...
 return {target,scenarioId:input.scenarioId||null,businessGoal:Array.isArray(input.businessGoal)?input.businessGoal:[],output:validateOutput(input.output),pipelineVersion:3};
}
