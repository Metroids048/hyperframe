...
for(const demo of [false,true]){
 ...
 const json={
 'scene.json':{schemaVersion:1,id,version:'3.0.0',aliases:demo?['demo','product_howto']:['launch'],creator:demo?'商家运营、产品运营、售前售后和内容团队':'中小商家、品牌运营、电商视觉和社媒内容运营',viewer:demo?'第一次操作该商品的新用户':'第一次认识该商品的潜在消费者',businessObjective:demo?'理解并基本复现真实操作':'建立商品认知与视觉印象，引发进一步了解',duration:{min:demo?30:20,max:demo?60:40,target:demo?45:30,policy:demo?'necessary action length takes precedence':'shorten if meaningful footage insufficient'},orientation:'derive from source composition and user intent',grammar,generatedFootageAllowed:false},
