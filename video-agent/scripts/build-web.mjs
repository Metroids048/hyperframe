...
await build({entryPoints:[path.join(ROOT,'web/commerce.js')],outfile:path.join(ROOT,'web-dist/commerce.js'),bundle:true,format:'esm',platform:'browser',target:'es2022'});
