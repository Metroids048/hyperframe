...
for(const file of ['index.html','style.css','editor.html','editor.css','editor.js','commerce.html','commerce.css','commerce.js'])await fs.copyFile(path.join(ROOT,'web',file),path.join(ROOT,'web-dist',file));
