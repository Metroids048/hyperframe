...
assert.equal(config.tools.media.video.maxBytes,15*1024*1024);
...
assert.equal(control.default,true);assert.equal(control.skills.length,12);assert.deepEqual(control.tools.allow,['video_project_list','video_project_open','video_task','video_job_status','video_result','video_cancel']);
